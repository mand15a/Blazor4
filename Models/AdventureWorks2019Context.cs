...
public class AdventureWorks2019Context :DbContext
{
    ...
    public AdventureWorks2019Context(DbContextOptions<AdventureWorks2019Context> options, IConfiguration configuration)
        : base(options)
    {
    ...
    public object UserBusinessEntityMappings { get; internal set; }

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        base.OnModelCreating(modelBuilder);

        // Configure the mapping for each entity to the existing table
       // modelBuilder.Entity<ApplicationUser>().ToTable("CustomUser");
        //modelBuilder.Entity<ApplicationRole>().ToTable("CustomClaim");
        // Add other entities and their corresponding tables as needed

        // Configure any other entity relationships, constraints, etc.

        // Disable migrations
        modelBuilder.Ignore<MigrationHistoryTable>();

        modelBuilder.Entity<ApplicationUser>(entity =>
        {

         entity.HasKey(e => e.BusinessEntityId).HasName("FK_ApplicationUser_BusinessEntityID");
         entity.Property(e => e.AuthenticationType).HasMaxLength(256);
         entity.Property(e => e.IsAuthenticated).IsRequired();
    ...
    internal static object GetUserByEmail(string email)
    {
